...
<body>
	...
	<div align="left">
		...
		<button style="outline: none;" class="w3-btn w3-white w3-border">롯데월드</button>
		<button style="outline: none;" class="w3-btn w3-white w3-border">에버랜드</button>
		<button style="outline: none;" class="w3-btn w3-white w3-border">서울랜드</button>
		<button style="outline: none;" class="w3-btn w3-white w3-border">경주월드</button>
		<button style="outline: none;" class="w3-btn w3-white w3-border">e
			월 드</button>
		<hr />
	</div>
    ...
    <div class="w3-third w3-container w3-margin-bottom" >
      <a href="/rideboard/detail.do?ride_name=${ride.RIDE_NAME}"><img src="${ride.IMAGE }" alt="Norway" style="width:100%;height: 150px;" class="w3-hover-opacity"></a>
      <div class="w3-container w3-white">
        <p><b>${ride.RIDE_NAME }</b></p>
        <p style="text-align: left">${ride.CONTENT }</p>
      </div>
    </div>
