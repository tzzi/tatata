...
<div class="w3-row-padding w3-content" style="max-width:1400px">
  <div class="w3-twothird">
    <img src="${rideboard.IMAGE }" alt="Notebook" style="width:500px;height: 400px">
    <h2>Empty Notebook Found</h2>
  </div>
  
  <div class="w3-third">
    <div class="w3-container w3-light-grey">
      <h2>조회수 :&nbsp;${rideboard.COUNT }&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="fa fa-thumbs-up w3-xxlarge">&nbsp;${rideboard.GOOD_CNT }</span></h2>
    ...
    <div class="w3-container w3-light-grey w3-justify">
      <h2>실시간 리뷰</h2>
      <p class="w3-justify">
      <small><b>평가리스트는 10초에 한번씩 자동 업데이트 됩니다. </b><br /> 남은시간 : <span
			id="sec"></span></small>
			<div id="rsc"
 ...
 <span class="star-input">
  ...
  <output for="star-input"><b>0</b>점</output>
		...
		<br />
		<textarea id="ment" name="ment" style="width: 451px; padding: 3px; height: 80px;"></textarea>
		<button type="button" id="sbt" style="width: 451px; padding: 3px;">
			<b>작성</b>
		</button>
			<br />
