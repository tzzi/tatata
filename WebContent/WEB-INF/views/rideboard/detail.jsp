...
<!-- 파크명 -->
	...
	<!-- 배경div -->
	<div class="w3-container row w3-center w3-card-4"
		style="background: url(/start/detail02.jpg) no-repeat center center fixed; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover;">
		<br /><br/>
		...
		<div class="col-2">
			...
			<div class=" w3-white w3-card-4 w3-container w3-round-large w3-section">
				<p>
				<h3 class="w3-round ">${rideboard.CONTENT }</h3>
				</p>
			</div>
			<div class="w3-white w3-card-4 w3-container w3-round-large w3-section">
			<p>
			<i class=" fa fa-child w3-text-black w3-xxlarge"></i>키 제한 : ${rideboard.LIMIT }&nbsp;&nbsp;&nbsp;
			<i class="fa fa-database w3-text-black w3-xxlarge"></i>이용요금 : ${rideboard.PRICE }&nbsp;<br/>
			<i class="fa fa-clock-o w3-text-black w3-xxlarge"></i>운영시간 : ${rideboard.TIME }
			</p>
			</div>
			<div class="w3-container w3-left">
			<br/><br/>
			<i class="fa fa-arrow-left w3-jumbo w3-text-white">&nbsp;&nbsp;C L I C K</i>
		</div>
        </div>
		<div class="col-1"></div>
	...
	<div class=" col-6"></div>
	<div class="w3-border col-8 w3-light-gray w3-round-large" align="center">
 ...
 <span class="star-input">
  <span class="input">
    <input type="radio" name="star-input" id="p1" value="1" class="score"><label for="p1">1</label>
    <input type="radio" name="star-input" id="p2" value="2" class="score"><label for="p2">2</label>
    <input type="radio" name="star-input" id="p3" value="3" class="score"><label for="p3">3</label>
    <input type="radio" name="star-input" id="p4" value="4" class="score"><label for="p4">4</label>
    <input type="radio" name="star-input" id="p5" value="5" class="score"><label for="p5">5</label>
    <input type="radio" name="star-input" id="p6" value="6" class="score"><label for="p6">6</label>
    <input type="radio" name="star-input" id="p7" value="7" class="score"><label for="p7">7</label>
    <input type="radio" name="star-input" id="p8" value="8" class="score"><label for="p8">8</label>
    <input type="radio" name="star-input" id="p9" value="9" class="score"><label for="p9">9</label>
    <input type="radio" name="star-input" id="p10" value="10" class="score"><label for="p10">10</label>
  </span>
