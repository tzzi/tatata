...
<div align="center" style="min-height: 80%">
		...
		<table>		
			...
			<tr>
				...
				<td></td>
				<td align="center">
				<input type="password" id="inputpass" name="inputpass" style="padding: 8px; font-size: 12pt; width: 250px;"/></td>
			...
			<tr>
				<td colspan="4" align="center">
					<br/>
					<button type="submit" id="modifyinfo" style="padding: 8px; font-size: 12pt; width: 120px" disabled>정보수정</button>
					...
					<a href="./mypageindex.do"><button type="button" style="padding: 8px; font-size: 12pt; width: 120px">이전으로</button></a>
				</td>
			</tr>
		</table>
		</form>	
