	...
	<div align="center" style="min-height: 80%">
		...
		<table>
			<tr>
				...
				<td align="center">${cookie.id.value }</td> 
			</tr>
			...
			<tr>
				<td colspan="2" align="center">
					...
					<a href="/account/dropform.jsp"><button type="button" class="btn btn-primary" style="padding: 8px; font-size: 12pt; width: 180px">회원탈퇴</button></a><br/>
				</td>
			</tr>
